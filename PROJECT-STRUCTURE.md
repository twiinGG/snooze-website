...
├── EXECUTION-GUIDE.md                 # ⭐ Complete execution guide for new sessions
│
...
│   ├── DEPLOYMENT-GUIDE.md            # ⭐ Single source of truth
...
### Planning & Strategy
- **Plans Index:** `docs/planning/PLANS-INDEX.md` - All project plans reference
- **MVP Plan:** `docs/planning/CONNECTED-EXPERIENCE-MVP-PLAN.md`
...
### Deployment Files
- **Navigation:** `kajabi-deployment/navigation.html`
...
→ `EXECUTION-GUIDE.md` ⭐ **START HERE** - Complete guide with ready-to-use prompt

**Implementation Plan?**  
→ `docs/planning/PLANS-INDEX.md` (overview)  
→ `docs/planning/CONNECTED-EXPERIENCE-MVP-PLAN.md` (detailed plan)  
→ `.cursor/plans/snooze-website-development-domain-migration-2259a5de.plan.md` (source)
...
2. Read `docs/planning/CONNECTED-EXPERIENCE-MVP-PLAN.md` (implementation plan)
