...
| A2 | Customizer → Theme Custom Code → **CSS** | website theme `settings-css-input` | [`global/css/theme-custom-code.css`](./global/css/theme-custom-code.css) | Website pages only | **MATCH.** Re-pasted 2026-08-08 (CNG-002) after the dead `#catnapping-guide-ready-page` rules were removed. Verified live: 374,958 chars (374,910 + 48 byte Kajabi wrapper), 2276 balanced braces, `#catnapping-guide-ready-page` 0 occurrences, sha256 `441a908ceb452dc3`. Two false starts logged in `4_working-cng002/RUN-LOG.md`: the first two pastes were made from the stale main-checkout copy of this file, not this worktree's copy | No |
