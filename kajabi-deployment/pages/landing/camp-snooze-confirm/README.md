...
- This page depends on a **checkout setting**, not on anything of its own: "Require new customers to create password at checkout", which Kade turned on for the camp offers on August 21, 2026. That is what puts a fresh buyer in a signed-in session before they land here. Without it, a new buyer arrives signed out and sees the signin state instead of the confirm button on every first visit.
