# ADDON-week-checkout.html - notes

Comments extracted from `ADDON-week-checkout.html`. That file is pasted into Kajabi and ships to
...
```
Add-on Week - checkout left column text block
```

============================================
     Add-on Week - checkout left column text block
     Offer:  2150720647 / fhuXVKZu   USD $350
             https://app.kajabi.com/admin/offers/2150720647/edit
     Theme:  2163241463   https://app.kajabi.com/admin/themes/2163241463/settings/edit
     Section 1744906803654, block 1787983700001 (text)
