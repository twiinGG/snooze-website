# 1-Month Free Membership - Email Sequence (USD)

Lifecycle emails for the 1-month free access offer (USD currency). Identical copy to `../emails-aud` except currency. Deployed to Kajabi as email campaign / automation emails. All styling is inline (Kajabi strips `<style>` blocks).
...
Upgrade offer link used across the sequence: `https://www.joinsnooze.com/offers/z63s9VaR` (canonical USD Snooze Access offer).
...
| `day-14-checkin-email.html` | Mid-point check-in | Email campaign sequence; 14 days after welcome | - | (see file) | (see file) |
...
## Pricing referenced in copy (USD)

- Quarterly: $197 every 3 months
- Annual: $657 per year (save $131 vs quarterly)
