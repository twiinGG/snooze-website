...
**Internal Code:** EMWL02  
**Campaign Name:** Camp Snooze Waitlist Launch - January 2026  
**Element Type:** campaign  
**Status:** active  
**Trigger/Context:** Waitlist signup for Camp Snooze (tag: camp-snooze-waitlist)  
**Target Audience:** Camp Snooze waitlist subscribers  
**Related Offer/Product:** PUBCM01  
**Number of Emails:** 3  
**Sequence Duration:** 6 days  
...
- Replace `[Enrollment Link]` with `https://www.joinsnooze.com/offers/muRW6ug5/checkout`.
- Replace `[First Name]` and `[Your Name]` with Kajabi personalization tokens.
