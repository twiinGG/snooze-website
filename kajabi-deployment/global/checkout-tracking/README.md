...
> **Merge note, August 17 2026.** This file arrived on `main` from `pm-002/organic-harvest`, where it
> was last written at 18:22 on August 16. ME-009 then changed both fields later the same evening: the
> Footer field was **deliberately cleared** at 21:53 and the identity capture was inlined into the
> Header file at 21:14. The "Live state 2026-08-16" table below therefore predates those two changes.
> [`../../PASTE-MAP.md`](../../PASTE-MAP.md) rows A4 and A5 carry the current state and win on any
> disagreement.
