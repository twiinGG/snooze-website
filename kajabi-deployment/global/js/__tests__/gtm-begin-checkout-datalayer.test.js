...
const campAud = run('wesGUFkc', 'A$997.00');
assert('Camp payment-plan emits once', campAud.length === 1);
assert('Camp payment-plan resolves AUD', campAud[0].ecommerce.currency === 'AUD');
assert('Camp payment-plan preserves numeric value', campAud[0].ecommerce.value === 997);
