 ...
 * Fix: only fill placeholder hrefs. Deploy via site-header-page-scripts.html.
 *
 * Usage:
...
const globalsPath = path.resolve(__dirname, '..', '..', 'html', 'site-header-page-scripts.html');
...
assert(
  ...
  'site-header-page-scripts.html contains offer-preserving normalize guard'
);
assert(
