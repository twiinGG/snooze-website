...
<section class="snooze-section bg-white" id="membership">
  <div class="snooze-container">
    ...
    <div class="store-featured-card">
      ...
      <h3>Snooze Access</h3>
      <p class="store-description">Get access to all courses, live sessions with the Snooze Specialists, troubleshooting support, and The Snooze Village community</p>
      ...
      <ul class="store-features">
        ...
        <li><i class="fa-solid fa-circle-check"></i> Live sessions with the Snooze Specialists</li>
